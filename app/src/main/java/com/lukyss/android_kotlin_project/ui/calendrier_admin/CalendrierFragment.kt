...
import com.lukyss.android_kotlin_project.databinding.FragmentCalendrierAdminBinding

class CalendrierFragment : Fragment() {

    private var _binding: FragmentCalendrierAdminBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCalendrierAdminBinding.inflate(inflater, container, false)
